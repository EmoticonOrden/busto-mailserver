...
4a. Replace all *PLACEHOLDERS* in `compose.yaml` and `mailserver.env` with your values. (for basic server operation)
4b. Replace the desired values in `mailserver.env` ​​with those that suit you.
